...
python3 scripts/eln.py export --interactive --open
echo
read -r -p "Copy everything in the file that opened and paste it into ChatGPT. Press Enter to close this window."
